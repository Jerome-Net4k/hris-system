...
<head>
    ...
    <script>
        ...
        $('#staticBackdrop').on('hidden.bs.modal', function () {
          ...
          $.ajax({
                  url: "proc_ipcrRatingSummary.php",
                  type: "POST",
                  ...
                  $.ajax({
                    data: {
                      ...
                      yearInput: yearInput
                        ...
                        url: "fileUpload.php",
                        success: function(data){
                          window.location.href = "views_ipcrRatingSummary.php"
                        }
                      })
...
<body>
    ...
    <div class="row pt-2 rounded bg-white">
        ...
        <div class="col border m-1">
            ...
            <thead>
                    <tr>
                        <th rowspan=2 style="width: 90px; border: 1px solid black;">Employee No.</th>                  
                        <th rowspan=2 style="border: 1px solid black;">Name</th>
                        <th colspan=4 style="text-align: center; border: 1px solid black;">1st Half</th>
                        <th colspan=4 style="text-align: center; border: 1px solid black;">2nd Half</th>
                        <!-- <th>Surname</th>
                        <th>Firstname</th>
                        <th>Middlename</th>
                        <th>Ext</th>                        -->
                    ...
                    <tr>
                        <th style="text-align: center; border: 1px solid black;">Q</th>
                        <th style="text-align: center; border: 1px solid black;">E</th>
                        <th style="text-align: center; border: 1px solid black;">T</th>
