  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">View IPCR</h5>
      ...
      <div class="modal-body">
       ...
       <tbody>
        ...
        <div class="col pt-2 d-flex justify-content-end">
          <button class="btn btn-dark p-1" id="inputData"><i class="fi fi-rr-layer-plus p-1"></i>Input Data</button>
        </div>
    </tr>    
            <tr>
                <th>Surname: </th>
