                  ...
                  $.ajax({
                    data: {
                      ...
                      yearInput: yearInput
                        ...
                        success: function(data){
                          window.location.href = "saln_view_uploadfile.php"
                        }
                      })
            ...
            <div class="row mb-2">
              <div class="col" style="max-width: 5%;">
                ...
                <div class="col-10 ps-1" style="display: inline-flex;">
                    ...
                    <a href="saln_checklist.php"><button class="btn btn-dark" id="searchInactive" style="margin-left: 10px;"><i class="fi fi-rr-search p-1"></i>View list</button></a>
                        <!-- SAMPLE LINK ONLY -->
                  </div>
            </div>
            <div class="row mb-2">
            ...
            <div class="row">
              ...
              <div class="col">
                <div style="margin-right: 100px; float: right;">
                  ...
                  *<b>Note2 : </b> <i>SALN FILE UPLOAD <b>EVERY YEARS.</b></i>
                </div>     
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-10 ">
                <div style="text-align: right;">
                  <p>Note: *SALN uploaded file needs to be issued every years.</p>
                </div>
              </div>
            </div>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-10 ">
                <div style="text-align: right;">
                  <p>Note: *SALN uploaded file needs to be issued every three years.</p>
                </div>
              </div>
            </div>
...
<script>
  ...
  function selecttabledate(dtryear){
    ...
    // alert(gsis);
      $.ajax({
        url: 'saln_indiload_checkyear.php',
        method: 'POST',
        data: { dtryear: dtryear,gsis:gsis },
        success: function(data) {
          $("#salnindiload").html(data);
        },
