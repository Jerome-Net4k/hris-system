...
<script>
    $(document).ready(function(){
        ...
        $("#ojt-search").on("keyup", function() {
            ...
            var coemonth = $("#dtrmonth").val();
            var coeyear = $("#coeyear option:selected").text();
            var sortval = "sname";
            var sortwhat = "ASC";
            // alert(searchinput);
            $.ajax({
				url:"coe_checklistproc.php",//orgsearchunder.php
				method:"POST",
                data: {
    ...
    <?php include 'navbar.php'; ?>
        <div  style="padding: 20px 0px 20px 50px">
            ...
            <div class="col-6 input-group w-50 rounded">
                ...
                <select name="coeyear" id="coeyear" class="form-select" style="width: 0px; margin-left: 10px;">
                <script>
                    ...
                    document.getElementById("coeyear").appendChild(option);
                    }
                </script>
                </select>
