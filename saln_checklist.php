...
<script>
    $(document).ready(function(){
        ...
        $("#saln-search").on("keyup", function() {
            var searchinput= $(this).val();
            var selectedOption = $("#salnyear").find(":selected");
            ...
            // alert(yearload);
            $.ajax({
				url:"saln_checklistproc.php",//orgsearchunder.php
				method:"POST",
                data: {
    ...
    <?php include 'navbar.php'; ?>
        <div  style="padding: 20px 0px 20px 50px">
            ...
            <div class="col-6 input-group w-50 rounded">
                ...
                <input type="search" id="saln-search" name="saln-search" class="form-control">
                <button class="btn btn-primary" id=""><i class="fi fi-rr-search p-1"></i>Search</button>

                <select name="salnyear" id="salnyear" class="form-select" style="width: 0px; margin-left: 10px;">
                    <script>
                        ...
                        document.getElementById("salnyear").appendChild(option);
                        }
                    </script>
                </select>
