...
<script>
  ...
  function load() {
    var pcrSelect = 'DPCR Department of Peformance ';
        ...
        buttons: [
          ['<button><b>YES</b></button>', function(instance, toast) {
            ...
            $.ajax({
              ...
              success: function(data) {
                window.location.href = "nosi_view_uploadfile.php";
              }
            });
          }, true],
            ...
            <div class="row mb-2">
              <div class="col" style="max-width: 5%;">
                ...
                <div class="col-10 ps-1" style="display: inline-flex;">
                    ...
                    <a href="nosi_checklist.php"><button class="btn btn-dark" id="searchInactive" style="margin-left: 10px;"><i class="fi fi-rr-search p-1"></i>View list</button></a>
                </div>
            </div>
            <div class="row mb-2">
            ...
            <div class="row">
              ...
              <div class="col-10 ">
                <div style="text-align: right;">
                  <p>Note: *NOSI uploaded file needs to be issued every three years.</p>
                </div>
              </div>
            </div>
...
<script>
  ...
  function selecttabledate(dtryear){
    ...
    // alert(dtryear);
      $.ajax({
        url: 'nosi_indiload_checkyear.php',
        method: 'POST',
        data: { dtryear: dtryear,gsis:gsis },
        success: function(data) {
          $("#nosiindiload").html(data);
        },
