        ...
        <div class="table-responsive" style="height: 750px; overflow-x: scroll;">
            <table class="table bg-white rounded table-hover" id="mainTable">
              <thead style="top: 0; position: sticky; background: whitesmoke; height: auto;">
                ...
                <th>
                  <div class="d-flex justify-content-center bpsort">SURNAME
                ...
                <th>
                  <div class="d-flex justify-content-center bpsort">FIRST NAME
      ...
      <tbody>
        <!-- <input type="text" class="form-control" id='idselect'> -->
            ...
            <tr>
                ...
                <th>Employment Type:</th>
                <td>
                  <select name="soa2" id="soa2" class="form-select">
                    <option value="regular" style="color: green;">Regular</option>
                    <option value="casual" style="color: yellow;">Casual</option>
                    <option value="job-order" style="color: red;">Job Order</option>
                  </select>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                  <select name="viewstatus" id="viewstatus" class="form-select">
